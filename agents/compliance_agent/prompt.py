...
2. Before flagging any issue:
   ...
   - If a developer constraint explicitly permits a deviation, treat it as compliant even if it breaks a standard — unless it creates legal or critical security risks.
...
- If issues are found, do not provide any Revised code/pseudocode.
